...
- (instancetype)initWithFrame:(CGRect)frame imageURLs:(NSArray *)imageURLs callBack:(void(^)(NSInteger index))selectImg{
...
- (void)initImages{
    ...
    if (self.imageURLs.count == 1) {
        ...
        [imageView sd_setImageWithURL:[NSURL URLWithString:self.imageURLs[0]] placeholderImage:ECIMAGENAME(@"zhanwei")];
