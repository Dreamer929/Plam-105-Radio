...
-(instancetype)init{
    ...
    self = [super init];
    if (self) {
        self.frame = CGRectMake(0, 190+80+10+120+10 + 180 + 10, DREAMCSCREEN_W, 180);
...
-(void)setUpView{
    ...
    flagImg.backgroundColor = ECCOLOR(45, 178, 141, 1);
    ...
    moreBtn.backgroundColor = ECCOLOR(45, 178, 141, 1);
    ...
    UIImageView *lhzImg = [[UIImageView alloc]initWithImage:ECIMAGENAME(@"bbtonghua")];
    ...
    UIImageView *wLImg = [[UIImageView alloc]initWithImage:ECIMAGENAME(@"bbgushi")];
    ...
    UIImageView *LybImg = [[UIImageView alloc]initWithImage:ECIMAGENAME(@"bbgongzhu")];
    ...
    UIImageView *mcsImg = [[UIImageView alloc]initWithImage:ECIMAGENAME(@"bb365")];
...
-(void)showInView:(UIView *)hostView aTusheng:(void (^)())aTushengClick sleep:(void (^)())sleep gongzhu:(void (^)())gongzhuClick years:(void (^)())yearsClick more:(void (^)())moreClick{
    ...
    self.aTuShengTouch = aTushengClick;
    self.sleepTouch = sleep;
    self.gongZhuTouch = gongzhuClick;
    self.yearsTouch = yearsClick;
